...
@Configuration
@EnableJpaRepositories(basePackages = "br.com.ana.alves.araujo.pokemon.repositories", entityManagerFactoryRef = "entityManagerFactory", transactionManagerRef = "transactionManager")
...
public class JpaConfiguration {
	...
	public LocalContainerEntityManagerFactoryBean entityManagerFactory() throws NamingException {
		...
		factoryBean.setPackagesToScan(new String[] { "br.com.ana.alves.araujo.pokemon.model" });
